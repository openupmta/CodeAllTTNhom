...
(function(h) {
    ...
    m.defaults = {
        ...
        oClasses: {},
        oLanguage: {
            oAria: { sSortAscending: ": click chuột để sắp xếp tăng dần", sSortDescending: ": click chuột để sắp xếp giảm dần" },
            oPaginate: { sFirst: "Đầu", sLast: "Cuối", sNext: "Sau", sPrevious: "Trước" },
            sEmptyTable: "Không có dữ liệu phù hợp trong bảng",
            sInfo: "Đang hiển thị từ _START_ đến _END_ trong _TOTAL_ bản ghi",
            sInfoEmpty: "Đang hiển thị từ 0 đến 0 trong 0 bản ghi",
            sInfoFiltered: "(Đã lọc từ _MAX_ bản ghi)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Hiển thị _MENU_ bản ghi/trang",
